            ...
            <div class="col-md-6">
                <div class="box_">
                        ...
                        <form role="form" action="" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="name" class="form-control" placeholder="" value="{{ old('name') }}">
                                </div>
                                <div class="form-group">
                                    <label>Статус</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control" id="description" rows="50" name="description">{!! old('description') !!}</textarea>
                                </div>
                            </div>
                    ...
                    @else
                        <div id="error_profile" class="alert alert-danger alert-dismissible" style="border-radius: 0;">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                            Сначала необходимо добавить хотя бы один статус задачи.
                        </div>
                    @endif
                </div>
            </div>
...
<script>
    $(function () {
        ...
        @if(old('end_time', false))
            startDate = "{{ old('end_time') }}";
        @endif
